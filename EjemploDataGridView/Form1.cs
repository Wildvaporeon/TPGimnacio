...
namespace EjemploDataGridView
{
    public partial class Form1 : Form
    {
        ...
        //esto se puede tomar desde cualquier metodo
        private List<Productos> productos = new List<Productos>();
        // Variable global para guardar el indice del producto seleccionado
        private int id; //es de cada elemento de la lista pero lo toma de la grilla
        //todos los atributos son privados los accedo desde setter y getter
        #endregion
        ...
        {          
            ...
            switch (btnGuardar.Text)
            {
                ...
                case "Guardar Cambios":
                     ...
                     */
                    productos[id].Nombre = txtNombre.Text;//el indice es el id 
        ...
        {
            try//si esta dentro de aca en vez de colgar el programa, captura el error y ejecuta lo q haga el catch
            {
        ...
        private void dtgProductos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //en q indice se posiciono el user de la grilla 
        }
        ...
        private void limpiarCampos(Control control)//Control es todos los controles(osea un contenedor) q hay y aca el dice q los renombra control
        {
            //Recorro los controles del del control recibido por parametro
            foreach (object item in control.Controls)//object es otro contenedor e item es el nombre q le dio a el 
            {
